...
import {ProjImage, ProjDetails, StyleGuideContainer } from '../ProjectElements';
const CustomModels = () => {
  const mockup = {
    width: "100%",
    marginLeft:"auto",
  ...
  return (
    <div>
      ...
      <StyleGuideContainer>
      <ProjImage>
        <img src={process.env.PUBLIC_URL + '/images/styleguide.png'} alt="on boarding comparison" style={mockup}></img>
        </ProjImage>
        <ProjDetails>
